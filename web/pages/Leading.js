...
function Leading(props) {
    ...
    <p>I used it myself for many months, working out all the kinks and making sure it could support all the ways I wanted to use it. Then I took a leap, launching it on Product Hunt. In a few days I had over a hundred users, and it's only grown from there. Turns out a lot of people loved the focus on fundamentals like seachability, simplicity and privacy. If you're up for leveling up your note-taking game so that you don't drop important details, you should consider giving it a try too! <strong>It's called Bosslog, and you can try it for yourself <a className="sp-cta" href="/?fromBlog=Leading">here</a>.</strong></p>

    <div className="sp-bio"><div className="columns"><div className="column is-one-fifth"><img className="sp-blog-profile" src="/img/tony.jpg" /></div><div className="column"><strong>Anthony Garvan</strong>
     &nbsp;is a software developer and engineering manager based out of Chicago. His apps have been used by over 50,000 people.</div></div></div></div></div><Footer /></Master>
}
